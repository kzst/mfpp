...
The package of *Matrix-based Flexible Project planning* (**mfpp**) models project structures for four types of project management approaches (PMas). The Table 1 summarizes the features of the project management structures.
...
Two project database is included. The first one is Boctor's (1993)  databese, which contain 240 simulated projects. All of them contains 4 completion modes. It can be used to test algorithms for multi-mode resource-constrained project scheduling problem (MM-RC-PSP). 
